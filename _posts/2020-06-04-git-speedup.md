...
如果是私人仓库，再当前及以后的每次连接远程仓库的时候，都需要输入账户和密码。  
...
点击“SSH and GPG keys”-“new SSH”,粘贴刚才复制的key并确认
...
可以根据上述网站的教程界面通过bash参数启动shadowsocks  
也可以通过本文下述方式启动，我当然推荐下述方式啦  
...
```
使用bash命令再简化启动过程
配置好你的ss配置文件后，放入一个shadowsocks文件夹  
